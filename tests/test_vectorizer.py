...
from tools.vectorizer import create_word_tokenizer, create_bpe_tokenizer, process_input, create_linformer_model

class TestVectorizer(unittest.TestCase):
    def setUp(self):
        self.sample_log = "[2024-03-18 10:15:23] INFO [system.service] Service started successfully"
